...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "CVCVideo_train_videos": {
            "img_dir": "../data/Downstream_Data/KUMC/KUMC/processed/train2019/Image",
            "anno_path": "../data/Downstream_Data/KUMC/KUMC/processed/train2019/Annotation",
            "img_index": "../data/Downstream_Data/KUMC/KUMC/processed/ImageSets/train.txt"
        },
        "CVCVideo_val_videos": {
            "img_dir": "../data/Downstream_Data/KUMC/KUMC/processed/val2019/Image",
            "anno_path": "../data/Downstream_Data/KUMC/KUMC/processed/val2019/Annotation",
            "img_index": "../data/Downstream_Data/KUMC/KUMC/processed/ImageSets/val.txt"
        },
        ####################### polyp ASUMayo #######################
